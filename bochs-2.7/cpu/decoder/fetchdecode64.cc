...
int decoder64_nop(const Bit8u* iptr, unsigned& remain, bxInstruction_c* i, unsigned b1, 
    unsigned sse_prefix, unsigned rex_prefix, const void* opcode_table)
{
    assert(b1 == 0x90);
...
const Bit8u* parseModrm64(const Bit8u* iptr, unsigned& remain, bxInstruction_c* i, 
    unsigned rex_prefix, struct bx_modrm* modrm)
{
    unsigned rex_r = 0, rex_x = 0, rex_b = 0;
    if (rex_prefix)
    {
...
fetch_b1:
    ...
    ia_opcode = decode_descriptor->decode_method(
        /*                    */    iptr,
        /*                    */    remain,
        /*                    */    i,
        /*                    */    b1,
        /*                    */    sse_prefix,
        /*                    */    rex_prefix,
        /*                    */    decode_descriptor->opcode_table);
